...
public class DubboGatewayImportBeanDefinitionRegistrar
	...
	public void registerWrapper(AnnotationMetadata metadata, BeanDefinitionRegistry registry)
		...
		scanner.addIncludeFilter(new AnnotationTypeFilter(GatewayDubboClient.class));
		...
		for (BeanDefinition candidateComponent : candidateComponents) {
			if (candidateComponent instanceof AnnotatedBeanDefinition) {
                ...
                Map<String, Object> annotationAttrMap = beanDefinition.getMetadata().getAnnotationAttributes(GatewayDubboClient.class.getCanonicalName());
                MergedAnnotation<GatewayDubboClient> gatewayDubboClient = beanDefinition.getMetadata().getAnnotations().get(GatewayDubboClient.class);
				...
				classWrapper = dubboApiWrapperFactory.make(attributes,
