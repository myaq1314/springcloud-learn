        ...
        for (String line : lines) {
            try {
                ...
                MetricEntity metricEntity = map.computeIfAbsent(key, s -> {
                    ...
                    initMetricEntity.setUpstreamFailQps(0L);
                    initMetricEntity.setCount(0);
                    initMetricEntity.setResource(node.getResource());
                    initMetricEntity.setClassification(node.getClassification());
                ...
                metricEntity.addUpstreamFailQps(node.getUpstreamFailQps());
